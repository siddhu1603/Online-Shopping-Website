...
<html 
    ...
    <outer>
        ...
        <cbody>
            ...
            <div class="bodymain">
                <myheader>View Product Reviews</myheader>
               
                <c:forEach items="${prlist}" var="prlist">
                    <h5>${prlist.getHeadline()}</h5>
                    Product : ${prlist.getProd_desc()}<br>
                    Rating : ${prlist.getRating()} star<br>
                    Reviewer By : ${prlist.getReviewername()} on ${prlist.getCrtdt()}<br>
                    Review : ${prlist.getReview()}<br>
                    Seller : ${prlist.getSellername()}
                    <hr>
                </c:forEach>
            </div>
            <div class="bodyright">
